...
class oldABBTests {
    ...
    void martin(){
        ABB <Integer> conjunto = new ABB<Integer>();
        conjunto.insertar(1000);
        conjunto.insertar(2000);
        conjunto.insertar(500);
        conjunto.insertar(250);
        conjunto.insertar(750);
        conjunto.insertar(550);
        conjunto.insertar(800);
        conjunto.insertar(549);
        conjunto.insertar(551);
        conjunto.insertar(790);
        conjunto.insertar(801);
        conjunto.insertar(795);
        conjunto.insertar(794);
        conjunto.insertar(796);
        conjunto.insertar(801);
        conjunto.eliminar(550);
        conjunto.insertar(550);
        conjunto.eliminar(111);
        assertEquals(14, conjunto.cardinal());
        assertEquals(2000,conjunto.maximo());
        assertEquals(250,conjunto.minimo());
        conjunto.eliminar(750);
        assertEquals(13, conjunto.cardinal());
        assertEquals(false, conjunto.pertenece(750));
        assertEquals(true,conjunto.pertenece(795));        
    }
